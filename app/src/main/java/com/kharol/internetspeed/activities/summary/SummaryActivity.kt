package com.kharol.internetspeed.activities.summary
...
import com.kharol.internetspeed.R
import com.kharol.internetspeed.database.DailyConsumption
import com.kharol.internetspeed.services.TrafficStatusService
import com.kharol.internetspeed.util.ChartUtils
import com.kharol.internetspeed.util.TrafficUtils
import com.kharol.internetspeed.viewmodels.ConsumptionViewModel
...
import com.kharol.internetspeed.activities.settings.SettingsActivity
import com.kharol.internetspeed.database.SharedPreferenceDB
import com.kharol.internetspeed.util.LargeValueFormatterBytes
...
class SummaryActivity : AppCompatActivity() {
    ...
    private fun getAllUsage(){
        ...
        viewModel.allConsumptions.observe(this,
            Observer<List<DailyConsumption>>(fun(dailyConsumption: List<DailyConsumption>) {
